package test;
 ...
 class OperatorTestUnitTest {
	...
	void opeatorTestUnitTestRelational() {
		...
		assertEquals(true,oT.notEqualTo(13,12),"");
		assertEquals(true,oT.greaterThan(13,12),"");
